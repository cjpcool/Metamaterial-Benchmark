...
from models.geoldm.qm9.analyze import check_stability
...
def sample_chain(args, device, flow, n_tries, dataset_info, prop_dist=None):
    ...
    if args.context_node_nf > 0:
        context = prop_dist.sample(n_nodes).unsqueeze(0)
...
def sample(args, device, generative_model, dataset_info,
    ...
    if args.context_node_nf > 0:
        ...
        context = context.repeat(1, max_n_nodes, 1).to(device) * node_mask
    else:
        context = None
